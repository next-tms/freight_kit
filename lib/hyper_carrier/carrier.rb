module HyperCarrier
  ...
  class Carrier
    ...
    #
    # @param origin [HyperCarrier::Location] Where the shipment will originate from.
    # @param destination [HyperCarrier::Location] Where the package will go.
    # @param packages [Array<HyperCarrier::Package>] The list of packages that will
    #   be in the shipment.
    # @param options [Hash] Carrier-specific parameters.
    # @return [HyperCarrier::RateResponse] The response from the carrier, which
    ...
    #   be in the shipment.
    # @param options [Hash] Carrier-specific parameters.
    # @return [HyperCarrier::ShipmentResponse] The response from the carrier. This
    ...
    # @param options [Hash] Carrier-specific parameters.
    # @return [HyperCarrier::TrackingResponse] The response from the carrier. This
    ...
    rescue HyperCarrier::ResponseError
      false
    else
      true
    end
