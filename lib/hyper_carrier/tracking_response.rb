module HyperCarrier
  ...
  # Represents the response to a {HyperCarrier::Carrier#find_tracking_info} call.
  #
  ...
  #   @return [Array<HyperCarrier::ShipmentEvent>]
  #
  ...
  class TrackingResponse < Response
    ...
    # @params (see HyperCarrier::Response#initialize)
    ...
    # @return [HyperCarrier::ShipmentEvent]
    def latest_event
