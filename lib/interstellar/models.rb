...
require 'interstellar/models/credential'
require 'interstellar/models/label'
require 'interstellar/models/price'
require 'interstellar/models/rate'
...
require 'interstellar/models/tracking_response'
