  ...
  class CarrierLogistics < Platform
    ...
    def parse_document_response(action, tracking_number, options = {})
      ...
      if url.include?('viewdoc.php')
        ...
        raise Interstellar::ResponseError, "API Error: #{self.class.name}: Document cannot be downloaded - link leads to about:blank"
      end
    ...
    def parse_tracking_response(tracking_number)
      ...
      raise Interstellar::ShipmentNotFound if response.body.downcase.include?('please enter a valid pro')
