...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency('activemodel', '>= 4.2', '< 8.1.4')
  spec.add_dependency('activesupport', '>= 4.2', '< 8.1.4')
  spec.add_dependency('active_utils', '>= 3.3.1', '< 3.6.0')
  spec.add_dependency('business_time', '~> 0.13.0')
  spec.add_dependency('httparty', '~> 0.10')
  spec.add_dependency('measured', '>= 2.0', '< 3.2.1')
  spec.add_dependency('mimemagic', '~> 0.4.3')
  spec.add_dependency('nokogiri', '>= 1.6', '< 1.19')
  ...
  spec.add_dependency('zeitwerk', '>= 2.6.0', '< 2.7.3')
