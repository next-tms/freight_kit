...
class RemoteStampsTest < ActiveSupport::TestCase
  ...
  def test_account_info
    skip 'Interstellar::ResponseError: Unable to write data to the transport connection: An existing connection was forcibly closed by the remote host.'
  ...
  def test_purchase_postage
    skip '<#<Interstellar::ResponseError: Unable to read data from the transport connection: An existing connection was forcibly closed by the remote host.>>.'
  ...
  def test_track_shipment
    skip '<#<Interstellar::ResponseError: Insufficient Postage>>.'
