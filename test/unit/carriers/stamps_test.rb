...
class StampsTest < ActiveSupport::TestCase
  ...
  def test_account_info
    ...
    assert_equal 'Interstellar::StampsAccountInfoResponse', account_info.class.name
  ...
  def test_purchase_postage
    ...
    assert_equal 'Interstellar::StampsPurchasePostageResponse', purchase_status.class.name
  ...
  def test_validate_address
    ...
    assert_equal 'Interstellar::StampsCleanseAddressResponse', cleansed_address.class.name
  ...
  def test_get_rates
    ...
    assert_equal 'Interstellar::RateResponse', rates.class.name

    assert_equal 2, rates.rates.length

    assert_equal 'Interstellar::StampsRateEstimate', rates.rates[0].class.name
  ...
  def test_create_shipment
    ...
    assert_equal 'Interstellar::StampsShippingResponse', indicium.class.name
  ...
  def test_track_shipment
    ...
    assert_equal 'Interstellar::TrackingResponse', tracking_response.class.name
