...
class StampsTest < ActiveSupport::TestCase
  ...
  def test_purchase_postage
    ...
    assert_equal 'HyperCarrier::StampsPurchasePostageResponse', purchase_status.class.name
  ...
  def test_validate_address
    ...
    assert_equal 'HyperCarrier::StampsCleanseAddressResponse', cleansed_address.class.name
  ...
  def test_get_rates
    ...
    assert_equal 'HyperCarrier::RateResponse', rates.class.name

    assert_equal 2, rates.rates.length

    assert_equal 'HyperCarrier::StampsRateEstimate', rates.rates[0].class.name
  ...
  def test_create_shipment
    ...
    assert_equal 'HyperCarrier::StampsShippingResponse', indicium.class.name
  ...
  def test_track_shipment
    ...
    assert_equal 'HyperCarrier::TrackingResponse', tracking_response.class.name
