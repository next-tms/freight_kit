...
class UPSTest < ActiveSupport::TestCase
  ...
  def test_find_tracking_info_should_return_a_tracking_response
    ...
    assert_equal 'Interstellar::TrackingResponse', @carrier.find_tracking_info('1Z5FX0076803466397').class.name
  end
  ...
  def test_response_parsing_an_oversize_package
    ...
    e = assert_raises(Interstellar::ResponseError) do
  ...
  def test_get_delivery_date_estimates_can_parse_delivery_estimates
    ...
    assert response.is_a?(Interstellar::DeliveryDateEstimatesResponse)
